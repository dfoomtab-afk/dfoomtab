...
ScreenGui.Name = "LoopTeleportGui"
    ...
    loopThread = task.spawn(function()
        while isLooping do
            ...
            if character and character:FindFirstChild("HumanoidRootPart") then
                -- التنقل المستمر فور تغيّر المكان
                character:PivotTo(targetCFrame)
            end
            task.wait(0.1) -- نسبة التكرار (كل 0.1 ثانية ينقلك فوراً)
        end
    end)
end
...
-- إعادة التفعيل التلقائي عند الموت أو إعادة المحاولة (Respawn)
